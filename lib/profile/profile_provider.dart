...
class ProfileProvider with ChangeNotifier {
  ...
  /// returnes a dealed [Freelancer], mainly used for [navigation]
  Future<Freelancer> getDealedFreelancer(String isbn) {
    return _freelancersService.getFreelancer(isbn);
  }

  /// Deletes a deal both from the users [profile] and from the freelancers [deals page]
  ...
  Future<bool> deleteProfileDeal(
    ...
    try {
      // remove deal from the freelancer
