              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                      labelText: loc
                          .getTranslatedValue('edit_profile_firstname_hint')),
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                      labelText:
                          loc.getTranslatedValue('edit_profile_lastname_hint')),
                  ...
                  onPressed: (_firstname.isEmpty || _lastname.isEmpty)
                      ...
                      : () async => onPressHandler(
                            ...
                            action: () async => await context
                                ...
                                .setProfileName(
                                    firstname:
                                        Profile.capitalizaName(_firstname),
                                    lastname:
                                        Profile.capitalizaName(_lastname)),
                            errorMessage: loc.getTranslatedValue('error_msg'),
                            successMessage: loc.getTranslatedValue(
                                'edit_profile_success_msg_hint'),
                          ),
