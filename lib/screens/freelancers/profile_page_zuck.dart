...
class ProfilePageZuck extends StatefulWidget {
  static String routeName = "/zuck";

  @override
  _ProfilePageZuckState createState() => _ProfilePageZuckState();
}

class _ProfilePageZuckState extends State<ProfilePageZuck> {
  late final _ratingController;
  late double _rating;

  double _userRating = 3.0;
  int _ratingBarMode = 1;
  double _initialRating = 4.8;
  ...
  Widget build(BuildContext context) {
    final user = UserPreferences.zuck;
...
class NumbersWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Row(
        ...
        children: <Widget>[
          ...
          buildDivider(),
          buildButton(context, '404', 'Seguindo'),
          buildDivider(),
          buildButton(context, '8.550', 'Seguidores'),
        ],
      );
