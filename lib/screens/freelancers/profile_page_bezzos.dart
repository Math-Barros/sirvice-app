...
class ProfilePageBezzos extends StatefulWidget {
  static String routeName = "/bezzos";

  @override
  _ProfilePageBezzosState createState() => _ProfilePageBezzosState();
}

class _ProfilePageBezzosState extends State<ProfilePageBezzos> {
  late final _ratingController;
  late double _rating;

  double _userRating = 3.0;
  int _ratingBarMode = 1;
  double _initialRating = 3.8;
  ...
  Widget build(BuildContext context) {
    final user = UserPreferences.bezzos;
...
class NumbersWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Row(
        ...
        children: <Widget>[
          ...
          buildDivider(),
          buildButton(context, '547', 'Seguindo'),
          buildDivider(),
          buildButton(context, '912', 'Seguidores'),
        ],
      );
