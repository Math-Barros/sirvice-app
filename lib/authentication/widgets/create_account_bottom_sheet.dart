            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                    labelText: loc.getTranslatedValue('reg_firstname_hint')),
                onChanged: (value) => _firstname = value,
              ),
              TextField(
                textCapitalization: TextCapitalization.words,
                decoration: InputDecoration(
                    labelText: loc.getTranslatedValue('reg_lastname_hint')),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                    labelText: loc.getTranslatedValue('reg_email_hint')),
                onChanged: (value) => _email = value,
              ),
              TextFormField(
                initialValue: _password,
                decoration: InputDecoration(
                    labelText: loc.getTranslatedValue('reg_password_hint')),
                obscureText: true,
