...
/// The deal class stores the inforamtion it needs from the user and the freelancer class
...
/// Also by storing object like [Profile] and [Freelancer], needs to map them from map and document
